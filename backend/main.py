...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://localhost:5174", "http://localhost:3000","https://hospital-voice-assistent-6vel-git-main-rakesh-mauryas-projects.vercel.app","hospital-voice-assistent-6vel-gccx15ink-rakesh-mauryas-projects.vercel.app"],
